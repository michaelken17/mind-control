import {
  ...
  export default function OCDTest() {
    ...
    const OCDQuestions = useSelector(
      (x) => x.persistedReducer.app.OCDQuestions
    );
    const OCDChoices = useSelector(
      (x) => x.persistedReducer.app.OCDChoices
    );
                ...
                <List>
                  {isLoaded &&
                    OCDChoices.map((value, index) => (
                      ...
                      >
                        <ListItemText primary={value.name[currentQuestion].indo} secondary={value.desc[currentQuestion].indo}/>
                      </ListItemButton>
                    ))}
                </List>
              </div>
